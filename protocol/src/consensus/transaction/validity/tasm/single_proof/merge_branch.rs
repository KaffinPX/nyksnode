...
use crate::consensus::block::block_transaction::BlockOrRegularTransaction;
use crate::consensus::block::block_transaction::BlockOrRegularTransactionKernel;
use crate::consensus::block::block_transaction::BlockTransactionKernel;
...
use crate::consensus::transaction::BFieldCodec;
use crate::consensus::transaction::Proof;
use crate::consensus::transaction::Transaction;
use crate::consensus::transaction::TransactionKernel;
use crate::consensus::transaction::TransactionKernelProxy;
...
use crate::consensus::transaction::transaction_kernel::TransactionKernelModifier;
use crate::consensus::transaction::validity::single_proof::DISCRIMINANT_FOR_MERGE;
use crate::consensus::transaction::validity::single_proof::SingleProof;
use crate::consensus::transaction::validity::single_proof::SingleProofWitness;
use crate::consensus::transaction::validity::tasm::authenticate_txk_field::AuthenticateTxkField;
use crate::consensus::transaction::validity::tasm::claims::generate_single_proof_claim::GenerateSingleProofClaim;
use crate::consensus::transaction::validity::tasm::hash_removal_record_index_sets::HashRemovalRecordIndexSets;
...
impl MergeWitness {
    ...
    ///
    /// Assumes the [`RemovalRecord`](crate::consensus::mutator_set::removal_record::RemovalRecord)s
