...
use crate::consensus::type_scripts::amount::TOO_BIG_COIN_FIELD_SIZE_ERROR;
use crate::consensus::type_scripts::amount::read_and_add_amount::ReadAndAddAmount;

/// Body for inner loop, running over all coins within one UTXO.
#[derive(Debug, Clone, Copy)]
pub struct AddAllAmountsAndCheckTimeLock {
...
#[cfg(test)]
mod test {
    use crate::consensus::type_scripts::amount::add_all_amounts_and_check_time_lock::AddAllAmountsAndCheckTimeLock;
    use crate::consensus::type_scripts::time_lock::TimeLock;
