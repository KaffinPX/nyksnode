...
use crate::type_scripts::amount::TOO_BIG_COIN_FIELD_SIZE_ERROR;
use crate::type_scripts::amount::read_and_add_amount::ReadAndAddAmount;
...
mod test {
    ...
    use crate::type_scripts::amount::add_all_amounts_and_check_time_lock::AddAllAmountsAndCheckTimeLock;
