...
impl ConnectionHandler for GatewayHandler {
    ...
    /// policy. Because Nyks handshakes are resource-intensive and
...
pub(crate) enum Command {
    ...
    /// performing the Nyks handshake over relayed connections.
...
/// "Direct-Only" policy for the Nyks sub-protocol. This policy means
...
///   limited bandwidth and substream slots. Running the Nyks consensus
