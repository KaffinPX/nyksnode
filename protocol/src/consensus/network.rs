...
use crate::consensus::block::difficulty_control::Difficulty;
...
impl Network {
    ...
    pub fn launch_date(&self) -> Timestamp {
        // 24 July 2026, 15:00:00 UTC
        Timestamp(BFieldElement::new(1784905200000u64))
    }
    ...
    /// - for mainnet and others: 384000 milliseconds equals 6.4 minutes.
    pub fn target_block_interval(&self) -> Timestamp {
        match *self {
            Self::RegTest => Timestamp::millis(100),
            Self::Main | Self::Testnet(_) | Self::TestnetMock => Timestamp::millis(384000),
        }
    }
}
...
mod tests {
    ...
    impl Network {
        pub fn all_networks() -> impl Iterator<Item = Self> {
